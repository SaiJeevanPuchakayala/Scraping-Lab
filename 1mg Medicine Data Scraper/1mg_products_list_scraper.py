...
from helpers import extract_source, create_csv, create_json
...
create_csv(products_list,"1mg_trending_products")

create_json(products_list, "1mg_trending_products")
